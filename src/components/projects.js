...
function Project(){
     ...
     data-aos="zoom-in">
      <div className="row secondDiv">
        ...
        <div className="col-lg-6 projectInfo" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <div className="ee">
          <a href = "https://glittering-meringue-d658ec.netlify.app" target="blank" className="anchor">
          ...
          <div className="credentials">
            <div>
              ...
              <p  className="demoCred">sunil@gmail.com</p>
              <p  className="demoCred" style={{color:"tomato"}}>Password :</p>
              <p  className="demoCred"> 12345678</p>
            </div>
          </div>
          </div>
    ...
    {/* projecct 2 */}
    <div style={{textAlign:"center"}}>
      <p className="title2 project2"><span style={{color:"tomato"}}> BOOK</span> STORE</p>
    </div>
    ...
    <div className="container" data-aos="zoom-in">
      <div className="row secondDiv">
        ...
        <div className="col-lg-6 projectInfo" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <p className="para1"><span className="imp">Book Store  </span>is a <span className="imp">Web Application</span>
          Develop a Book Store  Web Application that will be useful for managing Book Store ! 
 <span className="imp"> start </span> 
          ...
          <div style={{display:"flex" , marginTop:'15px' , flexWrap:"wrap" , position:"relative"}}>
            ...
            <a href="https://github.com/Shreedhar-sanakar/bookFRONT" target="blank" className="anchor">
            <button className="codeBtn">FrontEnd <i className="fab fa-github" style={{marginLeft:"8px"}}></i></button>
            </a>
            <a href="https://github.com/Shreedhar-sanakar/booklBACK" target="blank" className="anchor">
            <button className="codeBtn">BackEnd <i className="fab fa-github" style={{marginLeft:"8px"}}></i></button>
            </a>
            <div className="ee">
            <a href = "https://incandescent-peony-0887c8.netlify.app/" target="blank" className="anchor">
      ...
      <div className="row secondDiv">
        ...
        <div  className="usedIcons" >
          ...
          <div style={{display:"flex" , marginTop:'15px' , flexWrap:"wrap" , position:"relative"}}>
            ...
            <div className="ee">
            <a href = "https://joyful-bonbon-94a4df.netlify.app" target="blank" className="anchor">
            <button className="codeBtn">Live Demo <i className="fas fa-level-down-alt" style={{marginLeft:"8px"}}></i></button>
            </a>
            <div className="credentials">
            <div>
    ...
    <div className="container" data-aos="zoom-in">
      <div className="row secondDiv">
        ...
        <div className="col-lg-6 projectInfo" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <div className="ee">
          <a href = "https://endearing-belekoy-526a3e.netlify.app" target="blank" className="anchor">
            <button className="codeBtn">Live Demo <i className="fas fa-level-down-alt" style={{marginLeft:"8px"}}></i></button>
          </a>
          <div className="credentials">
            <div>
